...
public class KafkaAppender extends AppenderBase<ILoggingEvent> {
        ...
        try {
            ...
            producer.send(record, (metadata, exception) -> {
                if (exception != null) {
                    ...
                    addInfo("Log message sent to Kafka: " + metadata);
                }
            });
    ...
    private LogMessage createLogMessage(ILoggingEvent event) {
        ...
        customFields.put("hostname", getHostname());
        customFields.put("application", getApplicationName());
    ...
    private String getApplicationName() {
        return System.getProperty("spring.application.name", "sprival");
    }
